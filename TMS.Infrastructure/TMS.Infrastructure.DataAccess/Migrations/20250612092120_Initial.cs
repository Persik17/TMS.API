        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Users_TelegramAccounts_TelegramId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResetTokenExpiration = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CredentialHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CredentialHistories_Credentials_CredentialId",
                        column: x => x.CredentialId,
                        principalTable: "Credentials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CredentialHistories_Users_ChangedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoardUserRoles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BoardUserRoles_Boards_BoardId",
                        column: x => x.BoardId,
                        principalTable: "Boards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BoardUserRoles_Roles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BoardUserRoles_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoardUserRoles_BoardId",
                table: "BoardUserRoles",
                column: "BoardId");

            migrationBuilder.CreateIndex(
                name: "IX_BoardUserRoles_RoleId",
                table: "BoardUserRoles",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_BoardUserRoles_UserId",
                table: "BoardUserRoles",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CredentialHistories_ChangedById",
                table: "CredentialHistories",
                column: "ChangedById");

            migrationBuilder.CreateIndex(
                name: "IX_CredentialHistories_CredentialId",
                table: "CredentialHistories",
                column: "CredentialId");
