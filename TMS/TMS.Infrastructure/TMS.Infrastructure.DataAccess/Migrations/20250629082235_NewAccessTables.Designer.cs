...
namespace TMS.Infrastructure.DataAccess.Migrations
{
    ...
    [Migration("20250629082235_NewAccessTables")]
    partial class NewAccessTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TMS.Infrastructure.DataModels.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TMS.Infrastructure.DataModels.Membership", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TMS.Infrastructure.DataModels.Permission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TMS.Infrastructure.DataModels.RolePermission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TMS.Infrastructure.DataModels.Board", b =>
                {
                    b.HasOne("TMS.Infrastructure.DataModels.Department", "Department")
                        .WithMany("Boards")
            ...
            modelBuilder.Entity("TMS.Infrastructure.DataModels.RolePermission", b =>
                {
                    b.HasOne("TMS.Infrastructure.DataModels.Permission", "Permission")
